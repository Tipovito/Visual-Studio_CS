...
namespace Farm {
    ...
    public partial class farmDataSet : global::System.Data.DataSet {
        ...
        public partial class materiaisDataTable : global::System.Data.TypedTableBase<materiaisRow> {
            ...
            private global::System.Data.DataColumn columnmat_DS;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn mat_DSColumn {
                get {
                    return this.columnmat_DS;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public materiaisRow AddmateriaisRow(string mat_NM, string mat_Prof, string mat_DS) {
            ...
            internal void InitVars() {
                ...
                this.columnmat_DS = base.Columns["mat_DS"];
            }
            ...
            private void InitClass() {
                ...
                this.columnmat_DS = new global::System.Data.DataColumn("mat_DS", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnmat_DS);
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                ...
                this.columnmat_NM.MaxLength = 40;
                this.columnmat_Prof.AllowDBNull = false;
                this.columnmat_Prof.MaxLength = 30;
                this.columnmat_DS.AllowDBNull = false;
                this.columnmat_DS.MaxLength = 20;
            }
        ...
        public partial class materiaisRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public string mat_DS {
                get {
                    return ((string)(this[this.tablemateriais.mat_DSColumn]));
                }
                set {
                    this[this.tablemateriais.mat_DSColumn] = value;
                }
            }
        }
...
SELECT func_cd, func_Nm, func_End, func_Fone, func_email FROM fazenda.funcionarios WHERE (func_cd = @func_cd)";
    ...
    public partial class materiaisTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("mat_DS", "mat_DS");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [fazenda].[materiais] WHERE (([mat_CD] = @Original_mat_CD) AND ([mat_" +
                "NM] = @Original_mat_NM) AND ([mat_Prof] = @Original_mat_Prof) AND ([mat_DS] = @O" +
                "riginal_mat_DS))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_mat_DS", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "mat_DS", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [fazenda].[materiais] ([mat_NM], [mat_Prof], [mat_DS]) VALUES (@mat_N" +
                "M, @mat_Prof, @mat_DS);\r\nSELECT mat_CD, mat_NM, mat_Prof, mat_DS FROM fazenda.ma" +
                "teriais WHERE (mat_CD = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@mat_DS", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "mat_DS", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [fazenda].[materiais] SET [mat_NM] = @mat_NM, [mat_Prof] = @mat_Prof, [mat_DS] = @mat_DS WHERE (([mat_CD] = @Original_mat_CD) AND ([mat_NM] = @Original_mat_NM) AND ([mat_Prof] = @Original_mat_Prof) AND ([mat_DS] = @Original_mat_DS));
SELECT mat_CD, mat_NM, mat_Prof, mat_DS FROM fazenda.materiais WHERE (mat_CD = @mat_CD)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@mat_DS", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "mat_DS", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_mat_DS", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "mat_DS", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT mat_CD, mat_NM, mat_Prof, mat_DS FROM fazenda.materiais";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_mat_CD, string Original_mat_NM, string Original_mat_Prof, string Original_mat_DS) {
            ...
            if ((Original_mat_DS == null)) {
                throw new global::System.ArgumentNullException("Original_mat_DS");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_mat_DS));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string mat_NM, string mat_Prof, string mat_DS) {
            if ((mat_NM == null)) {
            ...
            if ((mat_DS == null)) {
                throw new global::System.ArgumentNullException("mat_DS");
            }
            else {
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(mat_DS));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string mat_NM, string mat_Prof, string mat_DS, int Original_mat_CD, string Original_mat_NM, string Original_mat_Prof, string Original_mat_DS, int mat_CD) {
            if ((mat_NM == null)) {
                throw new global::System.ArgumentNullException("mat_NM");
            }
            else {
            ...
            if ((mat_DS == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(mat_DS));
            }
            ...
            if ((Original_mat_DS == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_mat_DS));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string mat_NM, string mat_Prof, string mat_DS, int Original_mat_CD, string Original_mat_NM, string Original_mat_Prof, string Original_mat_DS) {
            return this.Update(mat_NM, mat_Prof, mat_DS, Original_mat_CD, Original_mat_NM, Original_mat_Prof, Original_mat_DS, Original_mat_CD);
        }
    }
